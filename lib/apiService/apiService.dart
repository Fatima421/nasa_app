...
class ApiService {
  ...
  Future<List<Apod>> get10Random() async {
    var url = 'api.nasa.gov';
    var urlExtension = '/planetary/apod';
    final Map<String, String> queryParameters = <String, String>{
      'api_key': '6u8YizBXHawwVvOgDaJXNXJoUoxQ2xTZzxXWC11Y',
  ...
  Future<bool> login(String user, String pass) async {
    ...
    var response = await http.post(Uri.parse(url), headers:{'Accept': 'application/json'}, body: {'username': user, 'password': pass});
...
Future<bool> markFav(String idUser, String date, String explanation, String title, String url, String copyright) async {
    ...
    var response = await http.post(Uri.parse(url), headers:{'Accept': 'application/json'}, 
                    body: {'idUser': idUser, 'date' : date, 'explanation' : explanation, 'title' : title, 'url' : url, 'copyright' : copyright});
